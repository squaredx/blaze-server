...
namespace Blaze.Server
{
    class PostAuthCommand
    {
        ...
        {
            Log.Info(string.Format("Client {0} post-authenticating", client.ID));
            ...
            var data = new List<Tdf>
            {
                ...
                new TdfStruct("TICK", new List<Tdf>
                {
                    ...
                    new TdfString("SKEY", string.Format("{0},127.0.0.1:8999,battlefield-3-pc,10,50,50,50,50,0,12", client.User.ID))
                }),
